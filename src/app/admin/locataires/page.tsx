...
const locatairesDemoData: Locataire[] = [
  {
    id: "1",
    nom: "Moussa Diop",
    telephone: "77 123 45 67",
    bien: "Apt F3 - Keur Issa",
    loyer: 150000,
    dateEntree: "2025-01-15",
    statut: "en_retard",
    dernierPaiement: "2026-05-01",
  },
  {
    id: "2",
    nom: "Awa Ndiaye",
    telephone: "78 234 56 78",
    bien: "Chambre - Mbour 3",
    loyer: 45000,
    dateEntree: "2025-06-01",
    statut: "en_retard",
    dernierPaiement: "2026-05-28",
  },
  {
    id: "3",
    nom: "Ibrahima Fall",
    telephone: "76 345 67 89",
    bien: "Studio - Cité Lamy",
    loyer: 85000,
    dateEntree: "2025-09-01",
    statut: "en_retard",
    dernierPaiement: "2026-06-02",
  },
  {
    id: "4",
    nom: "Fatou Sarr",
    ...
    statut: "a_jour",
    dernierPaiement: "2026-06-05",
  },
  {
    id: "5",
    nom: "Ousmane Ba",
    telephone: "78 567 89 01",
    bien: "Magasin - Centre-Ville",
    loyer: 200000,
    dateEntree: "2024-11-01",
    statut: "a_jour",
    dernierPaiement: "2026-06-03",
  },
];
...
export default function AdminLocatairesPage() {
  const [locataires, setLocataires] = useState<Locataire[]>(locatairesDemoData);
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    setLocataires([newLocataire, ...locataires]);
  ...
  function handleMarkPaid(id: string) {
    setLocataires(
      locataires.map((l) =>
        l.id === id
          ? { ...l, statut: "a_jour" as const, dernierPaiement: new Date().toISOString().split("T")[0] }
          : l
      )
    );
  }
