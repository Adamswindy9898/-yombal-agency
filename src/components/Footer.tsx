        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-white text-xl font-bold">YOMBAL</span>
            </div>
            <p className="text-white/60 max-w-md">
              Votre partenaire de confiance pour l&apos;immobilier et
              l&apos;assurance à Thiès. Nous vous accompagnons dans tous vos
              projets.
            </p>
            <div className="flex items-center gap-2 mt-4 text-white/60">
              ...
              <span>Keur Issa, Thiès, Sénégal</span>
            </div>
          </div>
